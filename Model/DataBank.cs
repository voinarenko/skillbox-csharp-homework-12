...
namespace Homework12.Model
{
    ...
    public static class DataBank
    {
        ...
        public static void OpenAccount(Client client)
        {
            ...
            // открытие нового счёта
            var newAccount = Open(generated, 0, client.Id, AccountType.NonDeposit);
            if (newAccount != null) db.Accounts?.Add(newAccount);
            db.SaveChanges();
        }
        
        public static Account? Open(int number, decimal sum, int clientId, AccountType accountType)
        {
